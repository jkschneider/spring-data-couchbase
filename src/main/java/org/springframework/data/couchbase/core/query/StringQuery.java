...
public class StringQuery extends Query {
	...
	public String toN1qlSelectString(CouchbaseConverter converter, String bucketName, String scope, String collection,
		...
		if (parameters instanceof JsonArray array) {
			this.setPositionalParameters(array);
		} else {
		...
		if (params instanceof JsonArray array) { // positional parameters
			paramIndexPtr = new int[] { array.size() };
